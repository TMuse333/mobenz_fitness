...
const Content = ({ title, image, description, rev, link, linkText, hasTitle, id, hasAnimation, hasTilt,imageId,
rotatingImage }) => {
            ...
            >
                {rev ? (
                    <div className="description-box">
                       ...
                       {description || 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Iste itaque voluptate eaque voluptatem fugit tempore, magnam amet adipisci eligendi repellendus repudiandae, sunt at distinctio? Culpa cumque at vel fuga. Exercitationem?'}
                          <br/>
                            {link != null && 
                                <Link to={link}>
                ...
                {rev ? null : (
                    <div className="description-box">
                        ...
                        >
                           {description || Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui ullam assumenda debitis eaque vel temporibus eum numquam distinctio facilis iste!
                            <br/>
                            {link != null && 
                                <Link to={link}>
                                    <button className="button">{linkText}</button>
