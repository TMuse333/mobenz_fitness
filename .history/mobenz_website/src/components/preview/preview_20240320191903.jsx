      ...
      <>
        ...
        <div className="details-box"
          ...
          {text.slice(0, 2).map((item, index) => (
            ...
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolorum atque consequuntur molestiae fugit dignissimos quae minima corrupti quod recusandae sit?</p>
